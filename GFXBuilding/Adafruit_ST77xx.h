...
#define ST_CMD_DELAY 0x80 // special signifier for command lists
  ...
  // ST77XX Register Settings
#define ST77XX_NOP 0x00 // No Operation
#define ST77XX_SWRESET 0x01 // Software Reset | Also maybe Hardware Reset and Power On sequence
#define ST77XX_RDDID 0x04 // Read Display ID
#define ST77XX_RDDST 0x09 // Read Display Status
  //
#define ST77XX_SLPIN 0x10 // Sleep in and Booster Off
#define ST77XX_SLPOUT 0x11  // Sleep out and Booster On
...
#define ST77XX_TEON 0x35  // Tearing Effect Mode Set and On
#define ST77XX_MADCTL 0x36  // Memory Data Access Control
#define ST77XX_COLMOD 0x3A  // Interface Pixel Format | Interface Format
  //
#define ST77XX_MADCTL_MY 0x80 // Row Address Order | Column address direction parameter
#define ST77XX_MADCTL_MX 0x40 // Column Address Order | Row address direction parameter
#define ST77XX_MADCTL_MV 0x20 // Row/Column  Order
#define ST77XX_MADCTL_ML 0x10 // Scan Direction Parameter 
#define ST77XX_MADCTL_RGB 0x00  // RGB/BGR Order
  //
#define ST77XX_RDID1 0xDA // Read ID1 Value
#define ST77XX_RDID2 0xDB // Read ID2 Value
#define ST77XX_RDID3 0xDC // Read ID3 Value
#define ST77XX_RDID4 0xDD // Read ID4 Value
